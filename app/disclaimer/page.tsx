...
export const metadata: Metadata = {
    title: "Disclaimer | India News Hindi",
    description:
        "Read the official disclaimer of India News Hindi. Understand content limitations, external links, advertising policies, and liability terms.",

    alternates: {
        canonical: "https://indianewshindi.com/disclaimer"
    },
    ...
    openGraph: {
        title: "Disclaimer | India News Hindi",
        description:
            "Important legal disclaimer for using India News Hindi website.",
        url: "https://indianewshindi.com/disclaimer",
    ...
    twitter: {
        ...
        title: "Disclaimer | India News Hindi",
        description:
            "Legal disclaimer for India News Hindi website usage.",
...
export default function DisclaimerPage() {
    ...
    const webPageSchema = {
        ...
        url: "https://indianewshindi.com/disclaimer",
        description:
            "Legal disclaimer explaining content accuracy, liability, and external link policies of India News Hindi.",
        inLanguage: "en-IN",
        isPartOf: {
            "@type": "WebSite",
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            },
            {
                ...
                position: 2,
                name: "Disclaimer",
                item: "https://indianewshindi.com/disclaimer"
            }
        ]
    }
