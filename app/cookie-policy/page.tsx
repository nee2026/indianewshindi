...
export const metadata: Metadata = {
    title: "Cookie Policy | India News Hindi",
    description:
        "Learn how India News Hindi uses cookies to improve user experience, analytics, advertising, and website functionality.",

    alternates: {
        canonical: "https://indianewshindi.com/cookie-policy"
    },
    ...
    openGraph: {
        title: "Cookie Policy | India News Hindi",
        description:
            "Understand how cookies are used on India News Hindi website.",
        url: "https://indianewshindi.com/cookie-policy",
    ...
    twitter: {
        ...
        title: "Cookie Policy | India News Hindi",
        description:
            "Official cookie usage policy of India News Hindi.",
...
export default function CookiePolicyPage() {
    ...
    const webPageSchema = {
        ...
        url: "https://indianewshindi.com/cookie-policy",
        description:
            "Cookie usage policy explaining analytics, advertising, and user preference tracking on India News Hindi.",
        inLanguage: "en-IN",
        isPartOf: {
            "@type": "WebSite",
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            },
            {
                ...
                position: 2,
                name: "Cookie Policy",
                item: "https://indianewshindi.com/cookie-policy"
            }
        ]
    }
            ...
            <main className="bg-neutral-50 dark:bg-neutral-900 min-h-screen font-sans">
                ...
                <section className="relative py-20 bg-[#321a1a] text-white overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
                        ...
                        <p className="mt-4 text-white/60 text-sm">Last Updated: 23 February 2026</p>
                    </div>
                </section>
